...
export function useProspects() {
  ...
  const addProspect = useCallback(async (data) => {
    ...
    ['nb_led','nb_led_reel','ca_previsionnel','ca_reel','surface','puissance_pac','nb_panneaux','nb_personnes_foyer','revenu_fiscal_ref','reste_a_charge','commission_pac','commission_admin','commission_telepro','commission_fournisseur','surface_sous_sol','surface_comble','surface_isoler_total','surface_habitable','surface_chauffer','surface_batiment','surface_mur_interieur','surface_mur_exterieur','surface_fenetre','hauteur_sous_plafond','puissance_chauffage','surface_groupe_froid','puissance_electrique','surface_serre','surface_bloc_froid'].forEach(k => {
  ...
  const duplicateProspect = useCallback(async (p) => {
    ...
    const copy = {
      ...
      surface_bloc_froid: null, statut_occupation: null, deja_prime_cee_deshumidificateur: false, type_cible: null,
    };
